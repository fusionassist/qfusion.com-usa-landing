...
export const industries: Industry[] = [
  {
    ...
    image: healthcareImg,
    intro:
      "From major hospital systems and academic medical centers to clinics, urgent care and outpatient departments, QueueFusion organizes every patient interaction — from arrival to consultation to follow-up — so staff can focus on care, not crowd control.",
    challenges: [
      { t: "Overcrowded waiting rooms", d: "Patients clustered around the front desk with no clear order." },
    ...
    solutions: [
      ...
      { t: "Departmental routing", d: "Automatically route patients between front desk, triage, exam rooms and pharmacy." },
    ...
    outcomes: [
      ...
      "HIPAA-ready, real-time KPIs for clinic managers",
    ],
  },
  {
    slug: "retail",
    name: "Retail",
    icon: ShoppingBag,
    tagline: "Turn lines into a better shopping experience.",
    image: retailImg,
    intro:
      "Whether it's curbside pickup, service desks, fitting rooms or in-store consultations, QueueFusion lets retailers manage walk-in demand without losing customers to long lines.",
    challenges: [
      { t: "Abandoned lines", d: "Customers leave when lines look too long." },
      { t: "Idle staff at peak", d: "No visibility into where help is needed most." },
      { t: "Curbside & BOPIS chaos", d: "Online orders pile up at the service desk." },
      { t: "No customer data", d: "Walk-in traffic goes unmeasured and untargeted." },
    ],
    solutions: [
      { t: "Mobile ticketing", d: "Customers join the line from a QR code and keep shopping until called." },
      { t: "Service desk routing", d: "Automatically split returns, pickups and inquiries to the right counter." },
    ...
    outcomes: [
      ...
      "Chain-wide reporting across every store",
    ],
  },
  {
    slug: "public-sector",
    name: "Public Sector",
    icon: Landmark,
    tagline: "Better public service, less red tape.",
    image: publicSectorImg,
    intro:
      "City and county government, DMV, IRS, SSA, immigration and social services offices handle huge daily footfall. QueueFusion brings order, transparency and accountability to every citizen interaction.",
    challenges: [
      { t: "Long, unpredictable lines", d: "Citizens arrive early and wait hours for routine services." },
      ...
      { t: "No service KPIs", d: "Hard to prove service standards to oversight bodies." },
    ],
    solutions: [
      { t: "Online appointments", d: "Citizens pre-book a slot and skip the line entirely." },
      { t: "Multi-service tickets", d: "One kiosk handles every department with clear category routing." },
      { t: "Multi-language UI", d: "ADA-friendly and multilingual, including Spanish out of the box." },
    ...
    outcomes: [
      ...
      "Inclusive, ADA-friendly service for all",
    ],
  },
  {
    slug: "finance",
    ...
    image: financeImg,
    intro:
      "Banks, credit unions, insurance and wealth management branches use QueueFusion to deliver a calm, premium customer experience — pairing walk-ins with the right specialist, every time.",
    challenges: [
    ...
    solutions: [
      { t: "Skill-based routing", d: "Automatically match customers to mortgage, lending or business advisors." },
      { t: "Appointment-first", d: "Pre-book complex services and let walk-ins fill the gaps." },
      { t: "Branded kiosks & displays", d: "Fully white-labeled to match your bank or credit union identity." },
    ...
    outcomes: [
      ...
      "Centralized oversight across the branch network",
    ],
  },
  {
    slug: "corporate",
    ...
    image: corporateImg,
    intro:
      "From HQ reception to multi-tenant buildings and campus environments, QueueFusion replaces the paper visitor log with a secure, branded, fully digital welcome experience.",
    challenges: [
      { t: "Paper visitor logs", d: "Insecure, privacy-risky and slow." },
    ...
    solutions: [
      ...
      { t: "Instant host alerts", d: "Hosts get an SMS, email or Teams/Slack notification the moment a visitor arrives." },
      { t: "Pre-registration", d: "Send invites in advance with QR codes for fast-track entry." },
      { t: "Evacuation reports", d: "One-tap on-site visitor list for emergency wardens." },
    ],
    outcomes: [
      "Professional, branded first impression",
      "CCPA-compliant visitor records",
